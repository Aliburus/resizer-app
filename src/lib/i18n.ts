...
export const translations = {
  tr: {
    ...
    fileTooLargeClient: "4MB'den büyük görseller yüklenemez",
  ...
  en: {
    ...
    fileTooLargeClient: "Images larger than 4MB cannot be uploaded",
  ...
  fr: {
    ...
    fileTooLargeClient:
      "Les images de plus de 4 Mo ne peuvent pas être téléchargées",
  ...
  zh: {
    ...
    fileTooLargeClient: "无法上传大于4MB的图片",
  ...
  de: {
    ...
    fileTooLargeClient: "Bilder über 4MB können nicht hochgeladen werden",
